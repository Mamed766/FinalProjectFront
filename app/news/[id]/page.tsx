          ...
          <div className="flex flex-col">
            ...
            <div className="flex pt-5 flex-col gap-2">
              ...
              <p className="text-white max-w-[1050px]">
                ...
                Arstibulum in ipsum velit. Aliquam libero sem asfds asf, rutrum
                eu scelerisque ut, vehicula a erat. Phasellus ac sem sed erat
                pos se quam dignissim. Mauris feugiat, nisi nec dapibuasas a gas
                dictum, ligula nulla gravida ante, non aliquet odio elit ac
                orci. Curabi tinc Nunc eu rhoncus justo, nec mattis risus auris
                consequat viverra sapien id lobortis.
              </p>
            </div>
            ...
            <div>
              <p className="max-w-[1050px] text-white pt-5">
                Aliquam libero sem asfds asf, rutrum eu scelerisque ut, vehicula
                a erat. Vestibulum in ipsum velit. Phasellus ac sem sed erat pos
                se quam dignissim. Mauris feugiat, nisi nec dapibuasas a gas
                dictum, ligula nulla gravida ante, non aliquet odio elit ac
                orci. Curabi tinc Nunc eu rhoncus justo, elit ac orci. Curabi
                tinc Nunc eu rhoncus justo,
              </p>
            </div>

            <div className="pt-5">
              <h2 className="text-[32px] text-white">Cras Tincidunt Lobort:</h2>
