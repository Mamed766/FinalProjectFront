      ...
      <div className="flex flex-wrap relative justify-between ">
        <div className="relative z-20">
          <Image
            ...
            height={1000}
            width={500}
            className="h-[50rem] pt-2 "
          />
        </div>
        <div className="flex flex-col relative z-20 justify-center ">
          <div>
            <h2 className="text-white text-[14px]">COOL LOOK</h2>
            <p className="text-white font-medium text-[50px] max-w-[500px]">
              We comprehend your style needs and create wonderful clothing
            </p>
          </div>
          <div className="">
            <div className="flex">
              <div className="flex flex-col items-center bg-black/30 px-10 py-7">
                <h2 className="text-[85px] text-[#BB9D7B] hover:text-white duration-700">
                  49+
                </h2>
                <p className="text-[18px] text-white hover:text-[#BB9D7B] duration-700 cursor-pointer">
                  TAILORS
                </p>
              </div>
            ...
            <div className="flex">
              ...
              <div className="flex ml-1 flex-col items-center bg-black/30 px-10 py-7">
                <h2 className="text-[85px] text-[#BB9D7B] hover:text-white duration-700">
                  774+
                </h2>
                <p className="text-[18px] text-white hover:text-[#BB9D7B] duration-700 cursor-pointer">
        ...
        <div className="flex flex-col gap-5 justify-center ">
          <div className="relative z-20 flex flex-col  ">
            <p className="max-w-[500px] text-[16px] text-white">
